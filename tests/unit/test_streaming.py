...
def test_client_connect_with_universal_3_6(mocker: MockFixture):
    actual_url = None
    ...
    params = StreamingParameters(
        sample_rate=16000,
        speech_model=SpeechModel.universal_3_6,
    )

    client.connect(params)

    assert "speech_model=universal-3-6" in actual_url


def test_client_connect_with_universal_3_6_pro(mocker: MockFixture):
    actual_url = None
    ...
    params = StreamingParameters(
        sample_rate=16000,
        speech_model=SpeechModel.universal_3_6_pro,
    )

    client.connect(params)

    assert "speech_model=universal-3-6-pro" in actual_url
